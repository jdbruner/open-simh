# open-simh with BlinkenBone and PiPD11 extensions

[This is ``.github/README.md``. You can find the simh README [here](../README.md).]

This repository integrates [open-simh](https://github.com/open-simh/simh)_: The Open SIMH simulators package_
...
```bash
git clone https://github.com/jdbruner/open-simh --recursive
```
...
##### No REALCONS builds on Windows or with cmake

There is currently no support for building a REALCONS-enabled simulator
on Windows (with either msbuild or mingw64) or with cmake.
...
- [The Open SIMH simulators package (GitHub)](https://github.com/open-simh/simh)
